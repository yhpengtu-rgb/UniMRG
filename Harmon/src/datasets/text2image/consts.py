...
def get_sketch_prompt_list():
    return [
        "Generate the sketch of this image.",
        "Create a sketch representation of this image.",
        "Produce a line drawing sketch from this image.",
        "Convert this image into a sketch.",
        "Generate a pencil sketch of this image.",
        "Create an outline sketch from this image.",
        "Transform this image into a sketch drawing.",
        "Produce a sketch version of this image.",
        "Generate a hand-drawn sketch of this image.",
        "Create a contour sketch from this image.",
        "Convert this photo into a sketch.",
        "Generate an artistic sketch of this image.",
        "Create a line art sketch from this image.",
        "Produce a sketch outline of this image.",
        "Transform this picture into a sketch.",
    ]


def get_mask_prompt_list():
    return [
        "Generate the segmentation mask of this image.",
        "Create a segmentation map for this image.",
        "Produce a semantic segmentation mask from this image.",
        "Segment this image into different regions.",
        "Generate instance segmentation masks for this image.",
        "Create object masks for all elements in this image.",
        "Produce a pixel-wise segmentation of this image.",
        "Generate masks showing all distinct objects in this image.",
        "Create a labeled segmentation map of this image.",
        "Segment and mask all visible objects in this image.",
        "Generate a mask overlay for this image.",
        "Create region-based segmentation masks for this image.",
        "Produce object detection masks for this image.",
        "Generate a panoptic segmentation mask of this image.",
        "Create boundary-aware segmentation masks for this image.",
    ]
